...
def test_schema_has_exactly_ten_columns():
    # Issue #73 added EdemaArea_um2, issue #72 added SwimBladderArea_um2 +
    # SwimBladderWidth_um (was 7 before either).
    assert len(TABLE_SCHEMA) == 10
