...
def test_run_analysis_starts_download_before_analysis_when_models_missing(widget_module):
    ...
    w._chk_edema = MagicMock()  # issue #73
    w._chk_swimbladder = MagicMock()  # issue #72
    w._chk_hitl = MagicMock()
    for chk in (w._chk_length, w._chk_curvature, w._chk_ratio, w._chk_eyes, w._chk_edema, w._chk_swimbladder, w._chk_hitl):
