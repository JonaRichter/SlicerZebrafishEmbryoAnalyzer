...
def compute_tube_metrics(mask, spacing=(1.0, 1.0)):
    ...
    Issue #72: ported from the reference webapp's length.py verbatim (same
    name/signature per this repo's CORE_SOURCE.md convention) — used for
    swim bladder area/width.
